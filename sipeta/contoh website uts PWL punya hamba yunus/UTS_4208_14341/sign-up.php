...
<head>
    ...
    <title>Sign Up - SaveYourLink</title>
...
<body class="text-center">
    ...
    if (isset($_POST["submit"])) {
        ...
        $queryCreated = "INSERT INTO user(username, pass) VALUES ('$username', '$pass')";
    ...
    <main class="form-signin w-100 m-auto">
        <div class="container bg-dark w-100 h-100" style="border:1px solid black;">
            <form class="mb-2" method="POST">
                ...
                <h1 class="h3 mb-3 fw-normal text-white">Silahkan isi form berikut</h1>
                ...
                <button class="w-40 btn btn-lg btn-primary" type="submit" name="submit">Daftar</button>
            </form>
            <span class="text-white fw-normal">
                Sudah daftar?
            </span>
            <a href="index.php"><button class="w-40 btn btn-sm btn-info">Login</button></a>
