    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <h1>Daftar Tiket yang Ada</h1> <br>
                <a class="btn btn-info" href="buattiket.php">Buat Tiket</a>
                <form role="search" method="POST" action="daftartiket.php">
                ...
                <table class="table p-3 table-bordered border-primary">
                    <thead class="table-dark">
                        <tr>
                            ...
                            <th scope="col">Kota Keberangkatan - Tujuan</th>
                    ...
                    <tbody>
                        ...
                        if (isset($_GET['id'])) {
                            $id = $_GET['id'];
                            $delete = mysqli_query($conn, "DELETE FROM pesanan_tiket WHERE id_pwt = $id");
                            $delete = mysqli_query($conn, "DELETE FROM log_transaksi WHERE id_pwt = $id");
                        }
                        ...
                        ?>
                                <tr class="bg-white">
                                    ...
                                    <td class="action">
                                        <a href="daftartiket.php?id=<?php echo $data["id_pwt"] ?>" class="btn btn-danger">Delete</a>
                                    </td>
                                </tr>
                                <?php
                            ...
                            if (isset($_POST["submit"])) {
                                $nama = $_POST["nama_pwt"];
                                $kota = $_POST["kota_brkt"];
                                $tujuan = $_POST["tujuan"];
                                $tanggal = $_POST["tgl_brkt"];
                                $jam = $_POST["jam_brkt"];
                                $harga = $_POST["harga_tiket"];

                                $queryCreated = "INSERT INTO pesanan_tiket(nama_pwt, kota_brkt, tujuan, tgl_brkt, jam_brkt, harga_tiket) 
                    VALUES ('$nama', '$kota', '$tujuan', '$tanggal', '$jam', '$harga')";
                            ...
                            if (mysqli_num_rows($show) > 0) {
                                ...
                                ?>
                                <tr class="bg-white">
                                    <td colspan="4" align="center">Belum ada maskapai</td>
                                </tr>
                        <?php
                            }
                        }
